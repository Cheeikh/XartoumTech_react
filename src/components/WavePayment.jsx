        ...
        <div className="flex flex-col justify-center items-center w-full h-[80vh] bg-gray-100">
            <form onSubmit={handleSubmit} className="bg-primary p-8 rounded-lg h-full w-full flex flex-col gap-5" >
                ...
                <div className="flex justify-center mb-4">
                    <img src="https://play-lh.googleusercontent.com/-Mp3XW7uhwn3KGQxUKGPoc4MbA5ti-3-q23TgoVi9ujBgHWW5n4IySvlG5Exwrxsjw" alt="Wave" className="w-20 h-20 rounded-full"/>
                </div>
                ...
                <div className="relative mb-6">
                    <input 
                        ...
                        className="w-full px-5 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500" 
                    />

                    <span className="absolute top-3 right-7 text-purple-500">
                    <svg fill="#7e22ce" height="25px" width="25px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 482.6 482.6" transform="rotate(270)" stroke="#7e22ce">
